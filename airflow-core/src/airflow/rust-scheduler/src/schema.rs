...
diesel::table! {
    ab_permission_view_role (id) {
        id -> Int4,
        permission_view_id -> Nullable<Int4>,
...
diesel::table! {
    ab_register_user (id) {
        ...
        #[max_length = 256]
        registration_hash -> Nullable<Varchar>,
    }
}
...
diesel::table! {
    ab_user (id) {
        ...
        fail_login_count -> Nullable<Int4>,
        created_on -> Nullable<Timestamp>,
        changed_on -> Nullable<Timestamp>,
        created_by_fk -> Nullable<Int4>,
        changed_by_fk -> Nullable<Int4>,
    }
}
...
diesel::joinable!(ab_permission_view -> ab_permission (permission_id));
diesel::joinable!(ab_permission_view -> ab_view_menu (view_menu_id));
diesel::joinable!(ab_permission_view_role -> ab_permission_view (permission_view_id));
diesel::joinable!(ab_permission_view_role -> ab_role (role_id));
diesel::joinable!(ab_user_role -> ab_role (role_id));
diesel::joinable!(ab_user_role -> ab_user (user_id));
