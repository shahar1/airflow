...
# module object and never imported by name - as of wave 8 the last of those call
# sites left this file, which is why ``import dagsource`` did too.  What is left is
# re-exported here, where a re-export is the same object because nothing rebinds them.
